...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'theme_homepage', 'quote',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.quote_link'
        db.add_column(u'theme_homepage', 'quote_link',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'theme_homepage', 'quote')

        # Deleting field 'HomePage.quote_link'
        db.delete_column(u'theme_homepage', 'quote_link')
